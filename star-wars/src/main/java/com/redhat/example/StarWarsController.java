...
public class StarWarsController {
  private static final List<String> characters = List.of("Luke Skywalker", "Darth Vader", "Leia Organa", "Stormtropper");
  ...
  private Span serverSpan(String path, String method) {
    return GlobalOpenTelemetry.getTracer(StarWarsController.class.getName())
        .spanBuilder(path)
